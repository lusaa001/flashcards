...
const Questions = [{
    id: 0,
    q: "hva er et typisk motiv i nyromantikken?",
    a: [{ text: "byen", isCorrect: false },
        { text: "teknorlogi", isCorrect: false },
        { text: "mennesker", isCorrect: true },
        { text: "modernismen", isCorrect: false }
    ]

},
{
    id: 1,
    q: "hva er et typisk temaer i modernismen?",
    a: [{ text: "menneskekroppen", isCorrect: false, isSelected: false },
        { text: "følelser", isCorrect: false },
        { text: "sosiale medier", isCorrect: false },
        { text: "storbyen", isCorrect: true }
    ]

},
{
    id: 2,
    q: "byens metafysikk er:",
    a: [{ text: "nyromantisk", isCorrect: false },
        { text: "kjedelig", isCorrect: false },
        { text: "modernistisk", isCorrect: true },
        { text: "tradisjonelt", isCorrect: false }
    ]
